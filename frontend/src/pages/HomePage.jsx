...
//       if (sortOrder === "Newest") return new Date(b.createdAt) - new Date(a.createdAt);
//       if (sortOrder === "Oldest") return new Date(a.createdAt) - new Date(b.createdAt);
//       if (sortOrder === "Trending") return b.likes - a.likes;
//       return 0;
//     });
...
//       <motion.section
//         className="text-center py-12 px-4 md:py-16 lg:py-20 transition-colors duration-300 mt-16 md:mt-0"
//         initial={{ opacity: 0, y: -20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.6 }}
//       >
...
//       <motion.div
//         className={`sticky top-0 z-20 ${darkMode ? "bg-gray-900/95" : "bg-white/95"} backdrop-blur-sm border-b ${
...
//         transition={{ duration: 0.3 }}
//       >
//         <div className="max-w-7xl mx-auto flex flex-col space-y-3 md:flex-row md:space-y-0 md:space-x-3">
...
//               value={searchTitle}
//               onChange={(e) => setSearchTitle(e.target.value)}
//               className={`block w-fit pl-10 pr-3 py-2.5 rounded-xl text-sm md:text-base ${
//                 darkMode 
...
//           <div className="flex space-x-2 w-full md:w-auto rounded-xl">
//             <select
//               value={category}
//               onChange={(e) => setCategory(e.target.value)}
//               className={`flex-1 min-w-0 px-3 py-2.5 rounded-lg border text-sm md:text-base ${
//                 darkMode 
...
//       {/* Blog Cards Section - Mobile First Design */}
//       <main className="max-w-7xl mx-auto px-4 py-6 md:px-6 md:py-8 lg:py-10">
//         {isLoading ? (
